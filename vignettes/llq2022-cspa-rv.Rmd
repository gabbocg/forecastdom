...
each $\hat h_j(x)$ (colored), their lower envelope (solid black)
...
low-VIX region — strong CSPA rejection ($\theta \approx -0.24$,
...
($\theta \approx -0.008$, p ≈ 0.01) — a borderline rejection
...
level. Cell $(k, l)$ counts the stocks where the null
